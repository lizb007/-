...
//                            result="高风险";//测试高风险
    ...
    public ArrayList<HashMap> searchWeekCheckin(HashMap param) {
        ...
        ArrayList<String> holidaysList = holidaysDao.searchHolidaysInRange(param);     //是否是特殊节假日
        ArrayList<String> workdayList = workdayDao.searchWorkdayInRange(param); //是否是特殊工作日
        ...
        range.forEach(one -> {
            ...
            String status = "";   //未到日期，设置为空字符串,防止误判     one, DateUtil.date()) <= 0 代表当天已经发生,可以查询
